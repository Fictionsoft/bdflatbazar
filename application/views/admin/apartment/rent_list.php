    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      ...
      foreach ($apartments as $key => $value) {
        ...
        echo 'class="bg"';
          ...
          <!--<td><a href="admin/apartment/rent_featured/<?php echo $value['id']; ?>"><img src="assets/images/<?php if($value['featured']==1){ echo 'on.gif'; }else{ echo 'off.gif'; } ?>" /></a></td>-->
          ...
          <td align="center"><a href="admin/apartment/rent_save/<?php echo $value['id']; ?>"><img src="assets/images/admin/edit.gif" width="16" height="16" alt="Edit" /></a></td>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>admin/apartment/rent_delete",
