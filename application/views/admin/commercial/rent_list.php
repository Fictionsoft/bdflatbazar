    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      ...
      foreach ($commercials as $key => $value) {
        ...
        echo 'class="bg"';
          ...
          <td align="right"><?php echo $value['company_name']; ?></td>
          <td align="right"><?php echo date('jS M Y ', strtotime($value['created'])); ?></td>
          <td align="center"><a href="admin/commercial/rent_save/<?php echo $value['id']; ?>"><img src="assets/images/admin/edit.gif" width="16" height="16" alt="Edit" /></a></td>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>admin/commercial/rent_delete",
