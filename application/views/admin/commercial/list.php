    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      ...
      foreach ($commercials as $key => $value) {
        ...
        echo 'class="bg"';
          ...
          <td><?php echo 'Holding No:' . $value['holding_no'] . ' House No:' . $value['house'] . '<br />Road No:' . $value['road'] . ' Sector:' . $value['sector']; ?></td>
          <td align="center"><?php echo $value['building_type']; ?></td>
          ...
          <td align="center"><a href="admin/commercial/save/<?php echo $value['id']; ?>"><img src="assets/images/admin/edit.gif" width="16" height="16" alt="Edit" /></a></td>
