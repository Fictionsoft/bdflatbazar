    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      ...
      foreach ($commercials as $key => $value) {
        ...
        echo 'class="bg"';
          ...
          <td><a href="admin/commercial/sale_featured/<?php echo $value['id']; ?>"><img src="assets/images/<?php if($value['featured']==1){ echo 'on.gif'; }else{ echo 'off.gif'; } ?>" /></a></td>
          <td><?php echo ' House No:' . $value['house'] . '<br />Road No:' . $value['road'] . ' Sector:' . $value['sector']; ?></td>
          <td align="center"><?php echo $value['project_name']; ?></td>
          <td align="right"><?php echo $value['project_status']; ?></td>
          <td align="right"><?php echo date('jS M Y ', strtotime($value['created'])); ?></td>
          <td align="center"><a href="admin/commercial/sale_save/<?php echo $value['id']; ?>"><img src="assets/images/admin/edit.gif" width="16" height="16" alt="Edit" /></a></td>
...
<script type="text/javascript">
  $(function(){
    $('.delete').click(function(){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>admin/commercial/sale_delete",
