<div id="center-column">
  <div class="table">
    ...
    <?php echo form_open_multipart('admin/leading_developer/add'); ?>
    <table class="listing form" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td class="last"><input type="text" name="web" autocomplete="off" value="www." /></td>
      </tr>
      <tr>
        <th class="full" colspan="2" style="text-align: center;">
          <input type="submit" name="submit" value="Create Leading Deveoper" />
        </th>
      </tr>
    </table>
    <?php echo form_close(); ?>
