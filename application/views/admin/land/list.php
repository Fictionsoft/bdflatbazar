    ...
    <table class="listing" cellpadding="0" cellspacing="0">
      ...
      foreach ($lands as $land) {
        ...
        echo 'class="bg"';
          ...
          <td><a href="admin/land/featured/<?php echo $land['id']; ?>"><img src="assets/images/<?php if($land['featured']==1){ echo 'on.gif'; }else{ echo 'off.gif'; } ?>" /></a></td>
          <td><?php echo 'Plot No:' . $land['plot_no'] . ' House No:' . $land['house'] . '<br />Road No:' . $land['road'] . ' Sector:' . $land['sector']; ?></td>
          ...
          <td align="center"><a href="admin/land/save/<?php echo $land['id']; ?>"><img src="assets/images/admin/edit.gif" width="16" height="16" alt="Edit" /></a></td>
