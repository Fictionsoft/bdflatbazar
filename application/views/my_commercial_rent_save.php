  ...
  <div class="home-item-box" style="margin-top: 5px;">
    <div class="title-bg">
      <div class="title-featured">
        <span id="">Commercial Rent Save</span>            
      </div>
    </div>
    <div class="clear">
    </div>
    <div>
      <div id="divHomeRent1">
        <form name="commercial" method="post" action="my_account/commercial_rent_save" enctype="multipart/form-data">
          <table border="0" cellpadding="2" cellspacing="2" style="font-size: 11px;">
            ...
            <tr>
              <td>Security</td>
              <td><input type="text" name="security_charge" value="<?php if (isset($commercial['security_charge'])) { echo $commercial['security_charge'];} ?>" style="width: 73px;" /></td>
              <td>Service Charge</td>
              <td colspan="3"><input type="text" name="service_charge" value="<?php if (isset($commercial['service_charge'])) { echo $commercial['service_charge'];} ?>" style="width: 73px;" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <select name="status" style="width: 80px;">
                  <option value="Active" <?php if (isset($commercial['status'])) { if ($commercial['status'] == "Active") { echo 'selected'; }} ?>>Active</option>
              ...
              <td colspan="3">
                <select name="validity" style="width: 80px;">
                  <option value="1-2 Months" <?php if (isset($commercial['validity'])) { if ($commercial['validity'] == "1-2 Months") { echo 'selected'; }} ?>>1-2 Months</option>
                  <option value="3-4 Months" <?php if (isset($commercial['validity'])) { if ($commercial['validity'] == "3-4 Months") { echo 'selected'; }} ?>>3-4 Months</option>
                  <option value="4-6 Months" <?php if (isset($commercial['validity'])) { if ($commercial['validity'] == "4-6 Months") { echo 'selected'; }} ?>>4-6 Months</option>
