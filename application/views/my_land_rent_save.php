<div class="home_middle">
  ...
  <div class="home-item-box" style="margin-top: 5px;">
    ...
    <div>
      <div id="divHomeRent1">
        <form name="land" method="post" action="my_account/land_rent_save" enctype="multipart/form-data">
          <table border="0" cellpadding="2" cellspacing="2" style="font-size: 11px;">
            <tr>
              <td width="100">Title :</td>
              <td colspan="5"><input type="text" required name="title" value="<?php if (isset($land['title'])) { echo $land['title'];} ?>" style="width: 410px;" /></td>
            </tr>
            <tr>
              <th colspan="6">&nbsp;</th>
            </tr>
            ...
            <tr>
              <td>Lease Price :</td>
              <td>
                <input type="text" name="price_total" value="<?php if (isset($land['price_total'])) { echo $land['price_total'];} ?>" style="width: 73px;" />
<!--                <select name="price_type" style="width: 80px;">
              ...
              <td>Advance Price :</td>
              <td colspan="3"><input type="text" name="advance_price" value="<?php if (isset($land['advance_price'])) { echo $land['advance_price'];} ?>" style="width: 73px;" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <select name="status" style="width: 80px;">
                  <option value="Active" <?php if (isset($land['status'])) { if ($land['status'] == "Active") { echo 'selected'; }} ?>>Active</option>
              ...
              <td colspan="3">
                <select name="validity" style="width: 80px;">
                  <option value="1-2 Months" <?php if (isset($land['validity'])) { if ($land['validity'] == "1-2 Months") { echo 'selected'; }} ?>>1-2 Months</option>
                  <option value="3-4 Months" <?php if (isset($land['validity'])) { if ($land['validity'] == "3-4 Months") { echo 'selected'; }} ?>>3-4 Months</option>
                  <option value="4-6 Months" <?php if (isset($land['validity'])) { if ($land['validity'] == "4-6 Months") { echo 'selected'; }} ?>>4-6 Months</option>
