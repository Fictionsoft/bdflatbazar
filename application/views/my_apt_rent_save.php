  ...
  <div class="home-item-box" style="margin-top: 5px;">
    <div class="title-bg">
      <div class="title-featured">
        <span id="">Apartment Rent Save</span>            
      </div>
    </div>
    <div class="clear">
    </div>
    <div>
      <div id="divHomeRent1">
        <form name="apartment" method="post" action="my_account/apt_rent_save" enctype="multipart/form-data">
          <table border="0" cellpadding="2" cellspacing="2" style="font-size: 11px;">
            ...
            <tr>
              <td>Project Name</td>
              <td><input type="text" name="project_name" value="<?php if (isset($apt['bed'])) { echo $apt['bed'];} ?>" style="width: 73px;" /></td>
              <td>Bed</td>
              <td>
            ...
            <tr>
              <td>Company Name</td>
              <td><input type="text" name="company_name" value="<?php if (isset($apt['bed'])) { echo $apt['bed'];} ?>" style="width: 73px;" /></td>
              <td>Car Parking</td>
              <td>
            ...
            <tr>
              <td>Rent Price</td>
              <td><input type="text" name="rent" value="<?php if (isset($apt['rent'])) { echo $apt['rent'];} ?>" style="width: 73px;" /></td>
              <td>Advance</td>
              <td><input type="text" name="advance" value="<?php if (isset($apt['advance'])) { echo $apt['advance'];} ?>" style="width: 73px;" /></td>
              <td>Security Charge</td>
              <td><input type="text" name="security_charge" value="<?php if (isset($apt['security_charge'])) { echo $apt['security_charge'];} ?>" style="width: 73px;" /></td>
            </tr>
            <tr>
              <td>Service Charge</td>
              <td colspan="5"><input type="text" name="service_charge" value="<?php if (isset($apt['service_charge'])) { echo $apt['service_charge'];} ?>" style="width: 73px;" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <select name="status" style="width: 80px;">
                  <option value="Active" <?php if (isset($apt['status'])) { if ($apt['status'] == "Active") { echo 'selected'; }} ?>>Active</option>
              ...
              <td colspan="3">
                <select name="validity" style="width: 80px;">
                  <option value="1-2 Months" <?php if (isset($apt['validity'])) { if ($apt['validity'] == "1-2 Months") { echo 'selected'; }} ?>>1-2 Months</option>
                  <option value="3-4 Months" <?php if (isset($apt['validity'])) { if ($apt['validity'] == "3-4 Months") { echo 'selected'; }} ?>>3-4 Months</option>
                  <option value="4-6 Months" <?php if (isset($apt['validity'])) { if ($apt['validity'] == "4-6 Months") { echo 'selected'; }} ?>>4-6 Months</option>
