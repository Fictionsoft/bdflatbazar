                        ...
                        <div class="financial_specification bottom40">
                            ...
                            <h4>
                                <?php if($type == "apt_sale"){
                                    ...
                                    echo '<p><b>Sales Price (sft) :</b> ' . $property['price_sft'].'</p>';

                                    echo '<p><b>Car Parking Price :</b> ' . $property['parking_price'].'</p>';

                                    echo '<p><b>Utility Price :</b> ' . $property['utility_price'].'</p>';

                                    echo '<p><b>Price (Total) :</b> ' . $property['price_total'].'</p>';

                                }elseif($type == "land"){

                                    echo '<p><b>Sales Price : </b>' . $property['sale_price'].'&nbsp;Per '.$property['price_type'].'</p>';

                                    echo '<p><b>Total Price :</b> ' . $property['total_price'].'</p>';

                                }elseif($type == "comm"){

                                    echo '<p><b>Sales Price :</b> ' . $property['rent'].'</p>';

                                    echo '<p><b>Total Price : </b>' . $property['advance'].'</p>';
                                }
                                ?>
                            </h4>
                        </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <table class="table table-striped table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo $property['land_status'] ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <table class="table table-striped table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo $property['project_status'] ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                            ...
                                            <div class="price clearfix">
                                                <span class="tag pull-right">
                                                    <?php if($type == "apt_sale"){ ?>
                                                        ...
                                                        PRICE : <?php echo $property['price_total']; ?>

                                                    <?php }elseif($type == "land"){ ?>

                                                        PRICE : <?php echo $property['total_price']; ?>

                                                    <?php }elseif($type == "comm"){ ?>

                                                        PRICE : <?php echo $property['rent']; ?>
